...
namespace MathsMania
{
    ...
    public sealed partial class HardPage : Page
    {
        ...
        public int char2;
        public int answer;
        char[] symbol1 = "+-*".ToCharArray(); //create a character array so random class can randomly pick plus, minus or multiply.
        String symbol2 = "=";
        ...
        private void Go_Click(object sender, RoutedEventArgs e)
        {
            ...
            // create a random object and pull plus, minus or multiply from array.
            Random ran1 = new Random();
            char1 = ran1.Next(symbol1.Length);
            char2 = ran1.Next(symbol1.Length);
            firstSymbol.Text = symbol1[char1].ToString();
            secondSymbol.Text = symbol1[char2].ToString();
